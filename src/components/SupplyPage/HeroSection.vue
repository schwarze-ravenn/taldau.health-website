      ...
      <div class="content-wrapper">
        <div class="content-layout">
          <main class="main-content">
            <article class="info-container" ref="contentContainer">
              <h1 ref="section2" class="title">Что такое {{ SupplyName }}?</h1>
              ...
              <h1 ref="section3" class="title">Какие эффекты от {{ SupplyName }}?</h1>
              ...
              <h1 ref="section4" class="title">База исследований {{ SupplyName }}</h1>
            </article>
          </main>
          ...
          <nav class="side-navigation" role="navigation">
            ...
            <ul class="nav-list">
              <li
                ...
                tabindex="0"
              >
                <span class="nav-item-indicator" :class="{ 'nav-item-indicator--active': activeSection === item.sectionRef }"></span>
                {{ item.text }}
              </li>
            </ul>
          </nav>
      ...
      this.observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
          if (entry.isIntersecting) {
            this.activeSection = entry.target.getAttribute('ref');
          }
        });
      }, options);

      ['section1, section2', 'section3', 'section4'].forEach(sectionRef => {
        const element = this.$refs[sectionRef];
        if (element) {
        ...
        <div class="content-layout">
          <main class="main-content">
            <article class="info-container">
              <h1 ref="section2" class="title" v-observe-visibility="{ callback: visibilityChanged }">
              ...
              <h1 ref="section3" class="title" v-observe-visibility="{ callback: visibilityChanged }">
              ...
              <h1 ref="section4" class="title" v-observe-visibility="{ callback: visibilityChanged }">
